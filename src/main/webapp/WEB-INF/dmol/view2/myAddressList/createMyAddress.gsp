...
<g:render template="/common/fragment/validatormessages" />
			...
			<g:form name="myAddressForm" action="saveMyAddress">
...
<g:render template="/myAddressList/personalTitle" model="${[fromList:personalTitleList, personalTitleId:'primaryNameSelection', personalTitleValue:myAddress?.primaryNameSelection ?: '様']}" />
				</td>
			</tr>
			<tr>
...
<g:render template="/myAddressList/personalTitle" model="${[fromList:jointPersonalTitleList, personalTitleId:'jointNameSelection1', personalTitleValue:myAddress?.jointNameSelection1 ?: '様']}" />
					<br />
...
<g:render template="/myAddressList/personalTitle" model="${[fromList:jointPersonalTitleList, personalTitleId:'jointNameSelection2', personalTitleValue:myAddress?.jointNameSelection2 ?: '様']}" />
					<br />
					<span class="red size10">※氏名と姓が同じ場合は姓の入力は不要です。入力すると姓も印字されますのでご注意下さい。</span>
				</td>
			</tr>
...
<g:render template="/myAddressList/personalTitle" model="${[fromList:jointPersonalTitleList, personalTitleId:'jointNameSelection3', personalTitleValue:myAddress?.jointNameSelection3 ?: '様']}" />
					<br />
					<span class="red size10">※氏名と姓が同じ場合は姓の入力は不要です。入力すると姓も印字されますのでご注意下さい。</span>
				</td>
			</tr>
...
<g:render template="/myAddressList/personalTitle" model="${[fromList:jointPersonalTitleList, personalTitleId:'jointNameSelection4', personalTitleValue:myAddress?.jointNameSelection4 ?: '様']}" />
					<br />
					<span class="red size10">※氏名と姓が同じ場合は姓の入力は不要です。入力すると姓も印字されますのでご注意下さい。</span>
				</td>
			</tr>
			...
			<tr>
				<th>会社敬称</th>
				<td>
<g:render template="/myAddressList/titleType" model="${[fromList:corporateTitleList, titleType:myAddress?.titleType ?: '御中']}" />
				</td>
			</tr>
			</table>
