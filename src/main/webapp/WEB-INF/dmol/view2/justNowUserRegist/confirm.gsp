...
<!-- commonContents -->
		<div class="commonContents w664">
			<h2>登録内容の確認</h2>
			<p>入力した内容を確認して「進む」ボタンを押してください。</p>
...
<input type="hidden" name="passwd1" value="${params.passwd1?.encodeAsHTML()}" />
<input type="hidden" name="passwd2" value="${params.passwd2?.encodeAsHTML()}" />
