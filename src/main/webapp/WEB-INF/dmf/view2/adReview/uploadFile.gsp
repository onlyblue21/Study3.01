...
<g:render template="/common/fragment/validatormessages" />
			...
			<g:uploadForm action="upload" name="uploadForm">
				...
				<a href="<g:createLink controller='adReview' action='index'></g:createLink>" id="goBack" class="button" onclick="" ><span class="icon-search">&nbsp;戻る&nbsp;</span></a>
				</div>
				<div>
					<button id="uploadBtn">審査結果をアップロードする</button>
				</div>
			</g:uploadForm>
