...
<g:form method="post" name="pageForm" action="${nextAction}">
<g:if test="${mapDrawup}">
...
$("#nextBtn").click(function() {
	document.pageForm.action = "${createLink(action:nextAction)}";
	document.pageForm.submit();
	return false;
});
$("#prevBtn").click(function() {
	document.pageForm.action = "${createLink(action:prevAction)}#servicingFormPosition";
	document.pageForm.submit();
	return false;
});
});</r:script>
