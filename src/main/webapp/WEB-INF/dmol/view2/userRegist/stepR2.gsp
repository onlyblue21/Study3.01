...
<g:render template="/common/fragment/validatormessages" />
			...
			<g:form name="userRegistForm" action="stepR3" onsubmit="return false;">
...
<g:set var="zipcode4" value="${(userInfo?.zipcode?.size() > 3) ? (userInfo.zipcode.substring(3)) : ''}" />
			...
			<tr>
				<th>町域名　<span class="red">必須</span><br />（全角）</th>
				<td>
...
$("#nextBtn").click(function() {
	if (formValidator.form()) {
		document.userRegistForm.zipcode.value = document.userRegistForm.zipcode3.value + document.userRegistForm.zipcode4.value;
		document.userRegistForm.telno.value = document.userRegistForm.telno0.value + '-' + document.userRegistForm.telno1.value + '-' + document.userRegistForm.telno2.value;
