...
<head>
	...
	<link rel="stylesheet" href="${resource(dir:'static/dmol/kanri/css',file:'dmolBiz.css')}" />
	<g:layoutHead />
...
<sec:ifLoggedIn>
		<div class="loginName">
			<a href="javascript:void(0)" id="editMyProfileBtn">${loginUserInfo?.familyName?.encodeAsHTML()}${loginUserInfo?.firstName?.encodeAsHTML()}</strong></a>　さま
		</div>
		<div class="box1">
...
<!-- /header END -->
	...
	<div class="breadcrumb bgGrad">
		<ul>
			<li><a href="javascript:void(0)" id="mainMenuBtn">メインメニュー</a></li>
		</ul>
	</div>
<g:layoutBody />
