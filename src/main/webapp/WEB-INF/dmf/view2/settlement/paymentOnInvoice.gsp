...
<g:if test="${isOK}">
	...
	<g:if test="${flash?.message}">
			<p class="mB15 red2">${flash.message}</p>
	</g:if>
				
			<img src="${resource(dir:'/static/dmol/users/images',file:'layout')}/c_chart_4.gif" class="mB20" />
			 <h2>請求書決済の説明</h2>
		        
			<!-- <iframe src="${g.resource(dir:'static/dmol/users', file:'paymentOnInvoiceHelp.html')}" frameborder="0" scrolling="no" width="100%" height="100%" marginheight="0"></iframe> -->
			 
			<g:render template="/common/fragment/paymentOnInvoiceHelp" />
	 		<h2>請求書決済の内容確認</h2>
...
$("#nextBtn").click(function() {
	...
	var url = '${createLink(controller:'settlement', action:'paymentOnInvoiceUpdate')}';
