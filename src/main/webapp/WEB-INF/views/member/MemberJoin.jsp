...
<form name="memberjoin" action="/memberjoin_j" method="post" onsubmit="return joinvalidate(this);" enctype="multipart/form-data" >
		<table>
			...
			<tr>
				<td>이름: <input type="text" name="user_name" value="" maxlength="8"/></td>
			</tr>
			<tr>
				<td>nick name : <input type="text" name="nick_name" value="" maxlength="12"/></td>
			</tr>
			<tr>
				<td>Email : <input type="text" name="email" value="" /></td>
			</tr>
			<tr>
				<td>Mobile Phone : <input type="text" name="phone_num" value="" maxlength="11"/></td>
			</tr>
			<tr>
				<td>address : <input type="text" name="address" value="" /></td>
			</tr>
			<tr>
				<td>생년 월일 : <input type="text" name="birth" value="" maxlength="6" /></td>
			</tr>
			<tr>
				<td>예) 911022</td>
			</tr>
			...
			<tr>
				<td>직업 : <select name="job"><option value="개발자">개발자</option>
						<option value="의사">의사</option></select></td>
			</tr>
			<tr>
				<td>종교 : <select name="religion"><option value="불교">불교</option>
						<option value="기독교">기독교</option>
						<option value="천주교">천주교</option></select></td>
			</tr>
			<tr>
				<td>자기 소개란 :</td>
				<td><textarea rows="5" cols="30" name="introduction" maxlength="255"></textarea></td>
			</tr>
		</table>
