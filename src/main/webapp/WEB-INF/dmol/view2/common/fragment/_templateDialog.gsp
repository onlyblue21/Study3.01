		...
		<div class="templateDialogRight" id="templateListArea">
			<div class="paginationBlock" style="display:none">
				<div class="pagination">
					<ul>
						<li class="pp"><a href="javaScript:void(0)"><img src="${r.resource(dir:'static/moon/images',file:'tool')}/btn_page_pp.gif" /></a></li>
						<li class="p"><a href="javaScript:void(0)"><img src="${r.resource(dir:'static/moon/images',file:'tool')}/btn_page_p.gif" /></a></li>
						<li><span class="dispPage1"></span></li>
						<li><span class="dispPage2"></span></li>
						<li><span class="dispPage3"></span></li>
						<li class="n"><a href="javaScript:void(0)"><img src="${r.resource(dir:'static/moon/images',file:'tool')}/btn_page_n.gif" /></a></li>
						<li class="nn"><a href="javaScript:void(0)"><img src="${r.resource(dir:'static/moon/images',file:'tool')}/btn_page_nn.gif" /></a></li>
					</ul>
