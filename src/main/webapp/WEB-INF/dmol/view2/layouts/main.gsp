...
<r:layoutResources />
<g:if test="${outputJustNowUserRegistConversion}"><g:render template="/common/fragment/justNowUserRegistConversion" /></g:if>
<g:if test="${outputUserRegistConversion}"><g:render template="/common/fragment/userRegistConversion" /></g:if>
<g:if test="${outputOrderConversion}"><g:render template="/common/fragment/orderConversion" /></g:if>
