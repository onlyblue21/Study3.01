...
<!-- commonContents -->
		<div class="commonContents w664">
			<img src="${r.resource(dir:'/static/dmol/users/images',file:'layout')}/i_chart_1.gif" width="620" height="54" class="mB20" />
			<h2>DMファクトリー　利用規約</h2>
...
(参考)<a href="http://www.post.japanpost.jp/deli_days/index.html" target="_blank">郵便物等のお届け日数を調べる</a></p>
			...
			<div class="align_center">
				<g:link controller="mainMenu" action="index" class="mR15"><img src="${r.resource(dir:'/static/dmol/users/images',file:'common')}/bt/btn_modoru.gif" alt="戻る" /></g:link>
...
<g:form method="get" name="nextForm" action="stepT2" />
<r:script>
;jQuery(function(){
