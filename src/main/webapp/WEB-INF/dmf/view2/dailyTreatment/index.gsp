				...
				<tr>
					<td height="40px">
						<div style="text-align: center;padding-top: 5px;">
							<a href="${createLink(controller:'dailyTreatment', action:'bankTransferInitialView')}" id="salesAccountBtn" class="button" >
							<span class="nowrap" >当日入金一覧CSV作成</span>
							</a>
						</div>
					</td>
					<td><div style="padding-top: 5px;padding-left: 5px;">当日入金一覧CSV作成画面を表示します。</div></td>
